      ...
      >
        ...
        {isEditing ? (
          <View style={styles.formContainer}>
            ...
            {(role === 'club' || role === 'admin') && (
              <View style={{ marginVertical: 10 }}>
                ...
                <PremiumInput
                  ...
                  icon={
                    <Ionicons name="logo-instagram" size={20} color={theme.colors.textSecondary} />
                  }
                />
                <PremiumInput
                  label="LinkedIn URL"
                  ...
                  icon={
                    <Ionicons name="logo-linkedin" size={20} color={theme.colors.textSecondary} />
                  }
                />
              </View>
            )}
            ...
            {role !== 'admin' && (
              <Text style={[styles.groupTitle, { marginBottom: 15, marginLeft: 4, marginTop: 10 }]}>
                Academic Info
              </Text>
            )}
            ...
            <View style={styles.menuGroup}>
              ...
              <View style={[styles.card, { backgroundColor: theme.colors.surface }]}>
                ...
                <View style={{ padding: 15 }}>
                    ...
                    {savedAccounts
                      ...
                      .map((acc, i) => (
                        ...
                        >
                          ...
                          >
                            <Text
                              style={[styles.accountAvatarText, { color: theme.colors.primary }]}
                            >
                  ...
                  <Text
                    style={[styles.helperText, { color: theme.colors.textSecondary, marginTop: 8 }]}
                  >
