    ...
    <SafeAreaView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <ScrollView contentContainerStyle={styles.content}>
        <View style={[styles.successHeader, { marginBottom: 20 }]}>
          ...
          <Text style={[theme.typography.h2, { color: theme.colors.text, marginTop: 10 }]}>
            You're Going!
          </Text>
        ...
        <View style={[styles.ticketCard, { shadowColor: theme.colors.primary }]}>
          ...
          <View
            style={[styles.notch, styles.notchLeft, { backgroundColor: theme.colors.background }]}
          />
          <View
            style={[styles.notch, styles.notchRight, { backgroundColor: theme.colors.background }]}
          />
        </View>
