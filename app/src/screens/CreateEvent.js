      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          <PremiumInput
            ...
            icon={<Ionicons name="text-outline" size={20} color={theme.colors.primary} />}
          />
        ...
        <View style={styles.section}>
          ...
          <View style={[styles.row, { justifyContent: 'space-between' }]}>
            ...
            <View style={{ width: '48%' }}>
              {renderDateInput('Ends', endDate, setEndDate, showEndPicker, setShowEndPicker, false)}
            </View>
          </View>
          ...
          <View style={styles.segmentContainer}>
            <TouchableOpacity
              style={[styles.segment, eventMode === 'offline' && styles.segmentActive]}
              onPress={() => setEventMode('offline')}
            >
              <Text
                style={[styles.segmentText, eventMode === 'offline' && styles.segmentTextActive]}
              >
                Offline
              </Text>
            </TouchableOpacity>
            ...
            >
              <Text
                style={[styles.segmentText, eventMode === 'online' && styles.segmentTextActive]}
              >
                Online
              </Text>
            </TouchableOpacity>
          ...
          {eventMode === 'online' ? (
            <View style={{ marginTop: 15 }}>
              <PremiumInput
                ...
                icon={<Ionicons name="link-outline" size={20} color={theme.colors.primary} />}
              />
              <TouchableOpacity
        ...
        <View style={styles.section}>
          ...
          <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.chipScroll}>
            {BRANCHES.map(b => (
              <TouchableOpacity
                key={b}
                style={[styles.chip, targetBranches.includes(b) && styles.chipActive]}
                onPress={() => toggleBranch(b)}
              >
                <Text
                  style={[styles.chipText, targetBranches.includes(b) && styles.chipTextActive]}
                >
                  {b}
                </Text>
              </TouchableOpacity>
          ...
          <View style={[styles.row, { flexWrap: 'wrap', gap: 10 }]}>
            {YEARS.map(y => (
              ...
              >
                <Text style={[styles.yearText, targetYears.includes(y) && styles.yearTextActive]}>
                  {y}st Year
                </Text>
              </TouchableOpacity>
            ))}
          ...
          {isPaid && (
            <View style={{ marginTop: 20 }}>
              <PremiumInput
                ...
                icon={<Ionicons name="cash-outline" size={20} color={theme.colors.primary} />}
              />
              <PremiumInput
                ...
                autoCapitalize="none"
                icon={<Ionicons name="wallet-outline" size={20} color={theme.colors.primary} />}
              />
            </View>
          )}
        ...
        >
          {loading ? (
            ...
            <Text style={styles.createBtnText}>{isEditMode ? 'Update Event' : 'Create Event'}</Text>
          )}
        </TouchableOpacity>
...
const getStyles = theme =>
  StyleSheet.create({
    ...
    sectionTitle: { fontSize: 18, fontWeight: '700', color: theme.colors.text, marginBottom: 15 },
