        ...
        <View style={[styles.modalContainer, { backgroundColor: theme.colors.background }]}>
          <ScrollView showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.header}>
              ...
              <Text style={[styles.title, { color: theme.colors.text }]}>Event Feedback</Text>
              ...
              <View style={styles.attendanceButtons}>
                <TouchableOpacity
                  style={[
                    ...
                    {
                      backgroundColor:
                        attended === true ? theme.colors.primary : theme.colors.surface,
                ...
                <TouchableOpacity
                  style={[
                    ...
                    {
                      backgroundColor:
                        attended === false ? theme.colors.error + '20' : theme.colors.surface,
            ...
            <View style={styles.actions}>
              <TouchableOpacity
                ...
                disabled={loading}
              >
                <Text style={[styles.buttonText, { color: theme.colors.text }]}>Later</Text>
              </TouchableOpacity>
