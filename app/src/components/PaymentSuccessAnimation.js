...
export default function PaymentSuccessAnimation({ visible, onComplete, amount }) {
  ...
  return (
    <Modal visible={visible} transparent animationType="none" statusBarTranslucent>
      <Animated.View
        style={[styles.container, { opacity: fadeAnim, backgroundColor: theme.colors.background }]}
      >
        {/* Ripples */}
        <Animated.View
          style={[
            styles.ripple,
            {
              ...
              transform: [
                { scale: ripple1.interpolate({ inputRange: [0, 1], outputRange: [0.8, 3] }) },
              ],
        ...
        <Animated.View
          style={[
            styles.ripple,
            {
              backgroundColor: theme.colors.primary,
              transform: [
                { scale: ripple2.interpolate({ inputRange: [0, 1], outputRange: [0.8, 3] }) },
              ],
        ...
        <Animated.View
          style={[
            styles.ripple,
            {
              backgroundColor: theme.colors.primary,
              transform: [
                { scale: ripple3.interpolate({ inputRange: [0, 1], outputRange: [0.8, 3] }) },
              ],
        ...
        <Animated.View
          style={[
            ...
            { transform: [{ scale: scaleAnim }], backgroundColor: theme.colors.surface },
          ]}
        >
          <LinearGradient
        ...
        {/* Branding Footer */}
        <Animated.Text
          style={[styles.footer, { color: theme.colors.textSecondary, opacity: checkmarkScale }]}
        >
          Secured by UniEvent
        </Animated.Text>
      </Animated.View>
