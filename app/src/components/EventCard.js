  ...
  return (
    ...
    >
      ...
      <View style={styles.contentContainer}>
        ...
        >
          <Image source={{ uri: flyerUrl }} style={styles.flyerImage} resizeMode="cover" />
        </View>
        ...
        <View style={styles.headerInfo}>
          ...
          <Text style={[styles.host, { color: theme.colors.secondary }]}>Hosted by {hostName}</Text>
        </View>
        ...
        <View style={styles.detailsRow}>
          ...
          <View style={[styles.priceBadge, { backgroundColor: theme.colors.secondary }]}>
            <Text style={styles.priceText}>{event.isPaid ? `₹${event.price}` : 'FREE'}</Text>
          </View>
        </View>
